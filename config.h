...
class CmdArgument {
    ...
    friend std::ostream & operator << (std::ostream & Str, CmdArgument const & v) {
            Str<< "cmd_argument{" << std::endl << v.option_name << "}"<<std::endl;
            return Str;
        }
};
...
class StdoutConfig {
    ...
    public:
        ...
        friend std::ostream & operator << (std::ostream & Str, StdoutConfig const & v) {
            Str<< "stdout_config:{" << std::endl << v.file << std::endl << v.mode << "}"<<std::endl;
            return Str;
        }
};
...
class Process {
    ...
    public:
        ...
        friend std::ostream & operator << (std::ostream & Str, Process const & v) {
            Str<< "Process{" << std::endl << v.name << std::endl << v.executable_path << std::endl<<v.stdout_config<<std::endl;
